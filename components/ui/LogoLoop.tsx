        ...
        const content = isNodeItem ? (
          ...
          <img
            className={cx(
              ...
              // 🎨 TAILWIND FILTERS (Requires `filter` class to activate)
              // "filter sepia hue-rotate-[230deg] saturate-[300%] brightness-125 opacity-60 transition-all duration-300 group-hover/item:opacity-100 group-hover/item:brightness-150",

...
const VIEW_W = 1200;
const VIEW_H = 100; // Scaled down canvas height so ribbon fits without clipping
const CX = VIEW_W / 2;
const CY = VIEW_H / 2;
const EDGE_PAD = 6;
...
const TextLoop = ({
  ...
  return (
    <div
      ref={rootRef}
      className={`relative w-full h-16 overflow-hidden flex items-center justify-center ${className}`.trim()}
      style={style}
    >
      <svg
